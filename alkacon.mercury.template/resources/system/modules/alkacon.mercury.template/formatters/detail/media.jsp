...
<mercury:piece
    ...
    <jsp:attribute name="heading">
        <c:if test="${not showOverlay}">
            ...
            <mercury:heading text="${preface}" level="${hsize + 1}" css="sub-header" ade="${ade}" test="${showPreface and keyPieceLayout == 0}" />
        </c:if>
    </jsp:attribute>
    ...
    <jsp:attribute name="text">
        <mercury:heading text="${preface}" level="${hsize + 1}" css="sub-header" ade="${ade}" test="${showPreface and not showOverlay and (keyPieceLayout != 0)}" />
