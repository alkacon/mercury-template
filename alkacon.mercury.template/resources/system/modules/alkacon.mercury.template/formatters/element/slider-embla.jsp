...
--%>><m:nl />
    ...
    <c:if test="${value.TextBackgroundColor.isSet}">
        <c:set var="rgbVal" value="${cms.color.toRgbStr(value.TextBackgroundColor)}" />
        <c:if test="${not empty rgbVal}">
            <c:set var="customVars">--my-slider-bg:${rgbVal};</c:set>
        </c:if>
    </c:if>
    <c:if test="${value.TextColor.isSet}">
        <c:set var="rgbVal" value="${cms.color.toRgbStr(value.TextColor)}" />
        <c:if test="${not empty rgbVal}">
    ...
    <c:if test="${not empty bgColorHead}">
        ...
        <c:set var="rgbVal" value="${cms.color.toRgbStr(bgColorHead)}" />
        <c:if test="${not empty rgbVal}">
    ...
    <c:if test="${not empty bgColorSub}">
        <c:set var="customClass" value=" custom" />
        <c:set var="rgbVal" value="${cms.color.toRgbStr(bgColorSub)}" />
        <c:if test="${not empty rgbVal}">
