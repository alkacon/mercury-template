var blogUGC = function($) {
    ...
    function myMappings() {
        ...
        ugc.map("imagecopyright", "Paragraph[1]/Image[1]/Copyright[1]",
                ugc.OPTIONAL);
   ...
   function hideError() {
        $('.ugc-error').addClass('disp-n');
    }
    function showError(out) {
        $('.ugc-error .text').html(out);
        $('.ugc-error').removeClass('disp-n');
        $('html, body').animate({
            scrollTop : $(".ugc-error").offset().top - 100
        }, 1000);
    }
};
