...
<%@ attribute name="deleteable" type="java.lang.Boolean" required="false"
    description="Activate delete option on the display formatter. If not specified the default is 'false'." %>
