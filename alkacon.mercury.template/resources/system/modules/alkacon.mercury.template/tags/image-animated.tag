                ...
                <c:if test="${not hideMobile}">
                    <cms:addparams>
                        ...
                        <m:image-srcset
                            ...
                            alt="${imgAlt}"
                            title="${imgTitle}"
                            cssImage="${mobileWrapper}animated${not empty cssImage ? ' ' : ''}${cssImage}${ratio eq '1-1' ? ' square' : ''}"
                            attrImage="${attrImage}"
                            isSvg="${imageIsSvg}"
                            addPaddingBox="${false}"
                            noScript="${noScript}"
                ...
                <c:if test="${adaptRatioToScreen and not hideDesktop}">
                    <cms:addparams>
                        ...
                        <m:image-srcset
                            ...
                            alt="${imgAlt}"
                            title="${imgTitle}"
                            cssImage="${desktopWrapper}animated${not empty cssImage ? ' ' : ''}${cssImage}${ratio eq '1-1' ? ' square' : ''}"
                            attrImage="${attrImage}"
                            isSvg="${imageIsSvg}"
                            addPaddingBox="${false}"
                            noScript="${noScript}"
