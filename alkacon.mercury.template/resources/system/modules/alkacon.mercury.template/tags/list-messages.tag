<%@ tag pageEncoding="UTF-8" display-name="list-messages" body-content="empty" trimDirectiveWhitespaces="true"
    ...
    <c:when test="${not cms.isOnlineProject}">
        ...
        <cms:bundle basename="alkacon.mercury.template.messages">
            ...
            <cms:edit createType="${type}" create="true"
                postCreateHandler="org.opencms.file.collectors.CmsAddCategoriesPostCreateHandler|${defaultCats}"
                ...
                <mercury:alert type="warning">
                    ...
                    <jsp:attribute name="text">
                        ...
                        <c:choose>
                            <c:when test="${type == 'binary'}">
                                <fmt:message key="msg.page.list.newentry.binary" />
                            </c:when>
                            <c:otherwise>
