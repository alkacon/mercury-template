...
public final class CmsStringCrypter {
    ...
    public static String decrypt(String value, String password) {
        ...
        if (CmsStringUtil.isEmptyOrWhitespaceOnly(value)) {
            if (LOG.isWarnEnabled()) {
                LOG.warn(LogMessages.get().getBundle().key(LogMessages.LOG_WARN_INVALID_DECRYPT_STRING_1, value));
            }
            return null;
        }
        ...
        try {
            ...
            byte[] cleartext = b64decoder.decode(value);
            ...
            if (LOG.isErrorEnabled()) {
                LOG.error(LogMessages.get().getBundle().key(LogMessages.LOG_ERROR_DECRPYT_0), ex);
            }
        }
    ...
    public static String encrypt(String value, String password) {
        ...
        if (CmsStringUtil.isEmptyOrWhitespaceOnly(value)) {
            if (LOG.isWarnEnabled()) {
                LOG.warn(LogMessages.get().getBundle().key(LogMessages.LOG_WARN_INVALID_ENCRYPT_STRING_1, value));
            }
            return null;
        }
        ...
        try {
            ...
            String base64encoded = b64encoder.encodeToString(ciphertext);
            ...
            if (LOG.isErrorEnabled()) {
                LOG.error(LogMessages.get().getBundle().key(LogMessages.LOG_ERROR_ENCRYPT_0), ex);
            }
        }
    ...
    private static byte[] getKey(String password) {
        ...
        try {
            ...
            if (LOG.isErrorEnabled()) {
                LOG.error(LogMessages.get().getBundle().key(LogMessages.LOG_ERROR_CREATE_KEY_0), ex);
            }
        }
        return null;
    }
