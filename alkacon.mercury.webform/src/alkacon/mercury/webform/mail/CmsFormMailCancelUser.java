...
/**
 * Form mail sent to the user if a registration is cancelled.
 */
public class CmsFormMailCancelUser extends A_CmsFormMailUser {

    /**
     * Creates a new mail for users if a registration is cancelled.
    ...
    protected String getMailText() {
        ...
        String mailText = CmsFormMailMessages.get().container(CmsFormMailMessages.INFO_CANCELLED_USER).key(
            m_cms.getRequestContext().getLocale());
        return "<p>" + mailText + "</p>";
    }
