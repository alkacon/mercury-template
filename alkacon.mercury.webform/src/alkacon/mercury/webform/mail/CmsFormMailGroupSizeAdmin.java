...
/**
 * Form mail sent to the administrator if a the group size for a user is changed.
 */
public class CmsFormMailGroupSizeAdmin extends A_CmsFormMailAdmin {

    /** The new group size. */
    private int m_groupSize;

    /**
     * Creates a new form mail for the administrator if a the group size for a user is changed.
     ...
     */
    public CmsFormMailGroupSizeAdmin(
    ...
    protected String getMailText() {
        ...
        String mailText = CmsFormMailMessages.get().container(
            CmsFormMailMessages.INFO_GROUPSIZE_ADMIN,
