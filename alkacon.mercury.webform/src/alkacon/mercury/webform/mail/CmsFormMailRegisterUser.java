...
/**
 * Form mail sent to the user when a user registers for the first time.
 */
public class CmsFormMailRegisterUser extends A_CmsFormMailUser {

    /**
     * Creates a new form mail for the user when the user registers for the first time.
     ...
     */
    public CmsFormMailRegisterUser(
    ...
    protected String getMailText() {
        ...
        return m_form.getConfirmationMailText();
    }
    ...
    protected String getMailTextPlain() {
        ...
        return m_form.getConfirmationMailTextPlain();
    }
}
