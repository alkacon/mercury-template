...
/** Interface, describing the "submissionerror" string template, with name and attributes. */
public interface I_CmsTemplateSubmissionError {

    /** Name of the string template. */
    final String TEMPLATE_NAME = "submissionerror";
    ...
    /** String attribute to output the error. */
